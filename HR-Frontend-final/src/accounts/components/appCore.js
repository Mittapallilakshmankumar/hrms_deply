...
const DEFAULT_APP_BASE_PATH = "/accounts";
...
export const APP_BASE_PATH = DEFAULT_APP_BASE_PATH;
...
function normalizeApiRequestUrl(url = "") {
  ...
  if (
    ...
    normalizedUrl.startsWith("finance/")
  ) {
  ...
  if (financeRoots.some((prefix) => normalizedUrl.startsWith(prefix))) {
    return `finance/${normalizedUrl}`;
  }
