...
#             "login_time": today_record.check_in.strftime("%I:%M %p") 
#               if today_record and today_record.check_in else None,

# "logout_time": today_record.check_out.strftime("%I:%M %p") 
#               if today_record and today_record.check_out else None,
